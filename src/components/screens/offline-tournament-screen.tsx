...
interface OfflineTournamentScreenProps {
  onBack: () => void;
}

export function OfflineTournamentScreen({ onBack }: OfflineTournamentScreenProps) {
    ...
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="p-4 pt-6 border-b border-border">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h1 className="text-2xl font-semibold">Offline Tournaments</h1>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Find tournaments near you</p>
                </div>
              </div>
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="bg-muted/50 rounded-xl p-3 mb-4">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <div>
                              <p className="font-medium text-sm">{tournament.venue}</p>
                              <p className="text-xs text-muted-foreground">{tournament.location} • {tournament.distance} away</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-2">
                            <Calendar size={16} className="text-accent" />
                            <div>
                              <p className="font-medium text-sm">{tournament.date}</p>
                  ...
                  <CardContent className="p-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground mb-2">{tournament.location}</p>
